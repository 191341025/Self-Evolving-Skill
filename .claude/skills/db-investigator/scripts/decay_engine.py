...
from core.parser import parse_decay_tags, scan_directory
from core.parser import increment_feedback, reset_entry
...
def run_reset(args: argparse.Namespace) -> int:
    ...
    # After reset, confidence is 1.0 (confirmed today, alpha=0, beta=0)
    c_val = confidence(
        result["type"],
        result["confirmed"],
        alpha=result["alpha"],
